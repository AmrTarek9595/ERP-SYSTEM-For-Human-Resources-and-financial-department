<template>
    <div class="container1" v-if="main">
	...
	<div class="signup">
		...
		<div class="form-holder">
			...
			<select name="" id="" class="form-control" v-model="type" required> 
				<option class="" value="" selected="selected" disabled>type</option>
				<option class="input" value="1">Main</option>
				<option class="input" value="3">Accountat</option>
				<option class="input" value="2">HR</option>
			</select>
		</div>
		<button class="submit-btn" v-on:click.prevent="showdata">Sign up</button>
	</div>
</form>
	<div class="login slide-up">
		<div class="center">
			<h2 class="form-title" id="login"></h2>
			<div class="form-holder">
   ...
   location.href="/login"
	...
	methods:{
		showdata:function(){
			...
			axios.post("https://erp.ersal.com.sa/api/auth/register",formdata).then(
				response=>{
