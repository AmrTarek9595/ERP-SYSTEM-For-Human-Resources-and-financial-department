...
<span class="mb-0 text-sm">Approved from Accountant
...
<span class="mb-0 text-sm">Not Approved yet
...
<form action="" method="POST" enctype= multipart/form-data>
  ...
  <div class="mb-6 pt-4">
    <label class="formbold-form-label formbold-form-label-2">
        finger print File: (Accept files with .xlsx .xlx only )
    </label>
