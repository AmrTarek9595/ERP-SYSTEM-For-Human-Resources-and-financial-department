...
<div class="col-xl-3 col-sm-6"><button  :onclick="displayform" class="btn btn-primary" >Add Emplyee</button>
</div>
...
<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Start Job Title</th>
<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">End Job Title</th>
...
<span class="text-secondary text-xs font-weight-bold">
  <router-link :to="'/single/emloyee?id='+data.id" class="btn btn-outline-primary btn-sm mb-0 me-3">View Profile</router-link></span>
</td>
...
<td class="align-middle text-left">
<span class="text-secondary text-xs font-weight-bold"><router-link :to="'/single/emloyee?id='+data2.id" class="btn btn-outline-primary btn-sm mb-0 me-3">View Profile</router-link></span>
</td>
  ...
  <div class="formbold-form-wrapper">
    <form action="" method="POST" enctype= multipart/form-data>
      <div class="formbold-mb-5">
        ...
        <select class="formbold-form-input" name="type_emplyee" v-model="h.status">
