<template>
    ...
    <h6 class="font-weight-bolder mb-0">Newcomer</h6>
    </nav>
...
<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Job Status</th>
<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Employee Status</th>
...
<td class="align-middle text-left text-sm">
<span class="mb-0 text-sm"><a class="btn btn-primary">Submit</a></span>
</td>
