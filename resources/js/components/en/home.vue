...
<img src="img/loading.gif" style="position: absolute;left: 40%; top:30%" v-if="!user_type">
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg " v-if="user_type">
...
<div class="col-8">
<div class="numbers">
<p class="text-sm mb-0 text-capitalize font-weight-bold">Actual Clients</p>
<h5 class="font-weight-bolder mb-0">
{{real_clients}}
...
<h5 class="text-white font-weight-bolder mb-4 pt-2">Financial Management</h5>
...
<div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url('/img/index/departments/hr.jpg'); background-size: 100% 100%;">
    <router-link to="/single/department_hr">
<span class="mask bg-gradient-dark"></span>
<div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
<h5 class="text-white font-weight-bolder mb-4 pt-2">Human Resources Management</h5>
...
<div class="col-lg-6">
<div class="card h-100 p-3">
<div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url('/img/index/departments/FourWeeks.jpg');">
    <router-link to="/single/department">
<span class="mask bg-gradient-dark"></span>
<div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
<h5 class="text-white font-weight-bolder mb-4 pt-2">FourWeeks management</h5>
...
">
        ...
        <h6>Updated Attendance Sheet</h6>
        ...
        <path style="fill:#CAD1D8;" d="M400,432H96v16h304c8.8,0,16-7.2,16-16v-16C416,424.8,408.8,432,400,432z"></path>
                    ...
                    <div class="timeline-content">
                        <a :href="'/fingerprintsfile/'+k.file_name" class="text-dark text-sm font-weight-bold mb-0"><h4> Fingerprint file</h4></a>
    ...
    <router-link  to="/sendmessage" style="text-decoration: none;text-transform: capitalize;font-family: sans-serif;font-size: 30px;font-weight: 700;padding: 20px 30px; color: black; background-color: aqua; box-shadow: 0 0 30px aqua; -webkit-box-reflect: below 0px linear-gradiant(transparent 10% , #ffffff55);">
    Send Message
    ...
    <path style="fill:url(#SVGID_3_);" d="M256,80.842c-104.179,0-188.632,70.378-188.632,157.193
        ...
        S360.179,80.842,256,80.842z"></path>
                ...
                <div class="timeline-content">
                    ...
                    <router-link :to="'/message?id='+k2.id" class="text-dark text-sm font-weight-bold mb-0" v-if="k2.to == 2"> To: HR</router-link>
                  
                    <router-link :to="'/message?id='+k2.id" class="text-dark text-sm font-weight-bold mb-0" v-if="k2.to == 3"> To: Accountat</router-link>
                    <br>
                    <router-link :to="'/message?id='+k2.id" class="text-dark text-sm font-weight-bold mb-0" > Subject: {{ k2.subject }}</router-link>
...
axios.post("https://erp.ersal.com.sa/api/auth/DisplayclientsProfile?token="+localStorage.getItem("access_token_agent")).then(
    ...
    response=>
    {
        this.real_clients=response.data.message.length
    }
