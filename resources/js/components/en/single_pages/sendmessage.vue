                     ...
                     <div class="sender-details">
                       <div class="details">
                         ...
                         <p class="sender-email" style="font-size:20px;display: inline-flex;gap:1em">
                            ...
                            To:<select class="form-select" style="  font-size: 22px;width: 303px;" v-model="to" required>
    ...
    <option value="4">HR+Finance</option>
                     ...
                     <div class="attachments-sections">
                       <ul style="justify-content: center;display: flex;">
                        <button class="btn btn-primary" style="display: inline-flex; gap: 2em;font-size: 20px;" :onclick="sendmessage"> <i class="fa-regular fa-paper-plane fa-1x"></i>Send</button>
