...
<img src="/img/loading.gif" style="position: absolute;left: 40%; top:30%; z-index: 1;" v-if="!user_type" >
    ...
    <h6 class="font-weight-bolder mb-0">المرتبات</h6>
    </nav>
...
<ul class="list-group">
    ...
    <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">شهر:</strong> &nbsp; <select class="form-control" v-model="insertmonth"> 
    ...
    <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">سنة:</strong> &nbsp; <select class="form-control" v-model="insertyear"> 
...
<!-- Salary Statement -->
<div class="col-12 col-xl-12" style="
    direction: rtl;
">
<div class="card h-100">
<div class="card-header pb-0 p-3">
<div class="row">
<div class="col-md-8 d-flex align-items-center">
<h6 class="mb-0">رواتب الموظفين</h6>
</div>
<div class="col-md-4 text-start">
    <router-link  to=""  style="float: right;left: 20px;position: relative;" :onclick="displayformtoemployeeform">
<button class="btn btn-primary">حساب الراتب للموظف</button>
</router-link>

<router-link  to=""  style="float: right;" :onclick="addexecuseviewform">
<button class="btn btn-primary">إضافة أعذار</button>
</router-link>
...
<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">إسم </th>
...
<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">عدد أيام الحضور</th>
<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">عدد أيام الغياب</th>

<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">عدد ساعات التأخير</th>
<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">عدد دقائق التأخير</th>

<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">دقائق الوقت الإضافي</th>
<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">ساعات الوقت الإضافي</th>
...
<div class="container-fluid py-6 px-3 " v-if="!form" style="direction: rtl;">
...
<button :onclick="displayformtopassfiletouploaddata"  style="float: left;background: none;border: none;">
...
<form  action="" enctype= multipart/form-data>
  ...
  <div class="mb-6 pt-4">
    <label class="formbold-form-label formbold-form-label-2">
        رفع ملف البصمة الشهرية لحساب أيام الحضور و الغياب: (Accept files with .csv only )
    </label>
  ...
  <div>
    ...
    <router-link  to="" class="formbold-btn w-full" :onclick="uploadfile">رفع</router-link>
  </div>
</form>
</div>
</div>
...
<div class="card mb-4">
<div class="card-header pb-0">
<button :onclick="displayformtoemployeeform"  style="float: left;background: none;border: none;">
    <svg height="40" viewBox="0 0 365.71733 365" width="40" xmlns="http://www.w3.org/2000/svg" id="fi_1828665"><g fill="#f44336"><path d="m356.339844 296.347656-286.613282-286.613281c-12.5-12.5-32.765624-12.5-45.246093 0l-15.105469 15.082031c-12.5 12.503906-12.5 32.769532 0 45.25l286.613281 286.613282c12.503907 12.5 32.769531 12.5 45.25 0l15.082031-15.082032c12.523438-12.480468 12.523438-32.75.019532-45.25zm0 0"></path><path d="m295.988281 9.734375-286.613281 286.613281c-12.5 12.5-12.5 32.769532 0 45.25l15.082031 15.082032c12.503907 12.5 32.769531 12.5 45.25 0l286.632813-286.59375c12.503906-12.5 12.503906-32.765626 0-45.246094l-15.082032-15.082032c-12.5-12.523437-32.765624-12.523437-45.269531-.023437zm0 0"></path></g></svg>
</button>

<h6>حساب الراتب للموظف</h6>
...
<label for="email" class="formbold-form-label">
  ...
  <div>
    ...
    <router-link  to="" class="formbold-btn w-full" :onclick="calculateSalary">حساب أيام الحضور</router-link>
  </div>
</form>
</div>
</div>
...
<div class="card mb-4">
<div class="card-header pb-0">
<button :onclick="addexecuseviewform"  style="float: left;background: none;border: none;">
    <svg height="40" viewBox="0 0 365.71733 365" width="40" xmlns="http://www.w3.org/2000/svg" id="fi_1828665"><g fill="#f44336"><path d="m356.339844 296.347656-286.613282-286.613281c-12.5-12.5-32.765624-12.5-45.246093 0l-15.105469 15.082031c-12.5 12.503906-12.5 32.769532 0 45.25l286.613281 286.613282c12.503907 12.5 32.769531 12.5 45.25 0l15.082031-15.082032c12.523438-12.480468 12.523438-32.75.019532-45.25zm0 0"></path><path d="m295.988281 9.734375-286.613281 286.613281c-12.5 12.5-12.5 32.769532 0 45.25l15.082031 15.082032c12.503907 12.5 32.769531 12.5 45.25 0l286.632813-286.59375c12.503906-12.5 12.503906-32.765626 0-45.246094l-15.082032-15.082032c-12.5-12.523437-32.765624-12.523437-45.269531-.023437zm0 0"></path></g></svg>
</button>
...
<label for="email" class="formbold-form-label">
  ...
  <select class="form-control" v-model="notes">
    <option value="1">إذن ساعة</option>
    <option value="2">يوم أجازة عرضة</option>
    <option value="3">يوم مدفوع مرتين</option>
    <option value="4">إضافة نصف ساعة</option>
 </select>
 <label for="email" class="formbold-form-label">
            التاريخ:
    </label>
  ...
  <div>
    <div class="mb-6 pt-4">
    <label class="formbold-form-label formbold-form-label-2">
      صورة الإذن: (Accept files with .jpg .png .pdf only )
    </label>
    ...
    <router-link  to="" class="formbold-btn w-full" :onclick="addexecuse">إضافة عذر</router-link>
  </div>
</form>
</div>
</div>
