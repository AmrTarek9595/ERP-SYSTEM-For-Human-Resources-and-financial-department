<template>
    ...
    <h6 class="font-weight-bolder mb-0">عروض العمل الجديدة</h6>
    </nav>
...
<h6 class="mb-0">عروض العمل</h6>
</div>
<div class="col-md-4 text-start">
<router-link  to="">
<i class="fa-solid fa-plus text-secondary text-sm" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Add New Job Offer" data-bs-original-title="Add New Job Offer"></i>
</router-link>
</div>
</div>
</div>
...
<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">تاريخ الإرسال</th>
<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">حالة الطلب</th>
...
<td>
<p class="text-xs font-weight-bold mb-0">20-5-2024</p>
</td>
<td class="align-middle text-left text-sm">
<select name="status" id="" class="form-select" style="direction: ltr;">
    <option>الموافقه</option>
    <option>الرفض</option>
...
<td class="align-middle text-left text-sm">
<a href="!#"><span class="mb-0 text-sm">
...
<td class="align-middle text-left text-sm">
<span class="mb-0 text-sm"><a class="btn btn-primary">تعديل</a></span>
</td>
