...
{{faildorsuccessmessage}}
    ...
    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">العهد المالية الرسلة</li>


    </ol>
    <h6 class="font-weight-bolder mb-0">العهدة المالية المرسلة</h6>
    </nav>
...
<div class="row">
<div class="col-md-8 d-flex align-items-center">
<h6 class="mb-0">حالة الأموال المرسلة</h6>
</div>
<div class="col-md-4 text-start">
...
<form action="" method="POST" enctype= multipart/form-data>
  ...
  <div class="mb-6 pt-4">
    <label class="formbold-form-label formbold-form-label-2">
      صورة الوصل: (Accept files with .zip .rar only )
    </label>

    <div class="formbold-mb-5 formbold-file-input">
      <input type="file" name="file_name" id="custody_file" accept=".png,.jpg,.pdf" class="form-control" @change="selectFile" required/>
