<template>
    ...
    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">الإدارات</li>
    </ol>
    <h6 class="font-weight-bolder mb-0">إدارة الموارد البشرية</h6>
    </nav>
    ...
    <div class="row" style="justify-content: center;">
        <div class="col-lg-3 col-md-4 col-sm-6">
            <router-link to="/ar/employee">
            <div class="serviceBox">
                <h3 class="title">الموظفيين</h3>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
            <router-link to="/ar/fingerprint">
            <div class="serviceBox">
                <h3 class="title">ملفات البصمة</h3>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
            <router-link to="/ar/newcomer">
            <div class="serviceBox">
                <h3 class="title">العقود الجديدة</h3>
    ...
    <div class="row" style="justify-content: center;margin-top: 20px;">
        <div class="col-lg-6 col-md-4 col-sm-6">
            <router-link to="/ar/execuses">
            <div class="serviceBox">
                <h3 class="title">الأعذار</h3>
        ...
        <div class="col-lg-6 col-md-4 col-sm-6">
            <router-link to="/ar/cv">
            <div class="serviceBox">
                <h3 class="title">السيرة الذاتية</h3>
