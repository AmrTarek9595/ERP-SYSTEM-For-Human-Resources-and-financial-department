...
{{faildorsuccessmessage}}
    ...
    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">الأصول الثابتة</li>
    </ol>
    <h6 class="font-weight-bolder mb-0">الأصول الثابتة</h6>
    </nav>
...
<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">الرقم المسلسل</th>
<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2" style="padding-right: 0px;">النوع</th>
<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2" style="padding-right: 0px;"> الماركة</th>
<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2" style="padding-right: 0px;">شهر </th>
<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2" style="padding-right: 0px;">سنة </th>
<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2" style="padding-right: 0px;">التكلفة</th>
<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2" style="padding-right: 0px;">ملاحظات</th>
<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2" style="padding-right: 0px;">فاتورة الشراء</th>
</tr>
</thead>
<tbody>
