...
{{faildorsuccessmessage}}
    ...
    <h6 class="font-weight-bolder mb-0">التموين</h6>
    </nav>
...
<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2" style="padding-right: 0px;">المبلغ</th>
<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2" style="padding-right: 0px;">ملف الدفع</th>


</tr>
</thead>
<tbody>
<tr v-for="(data , index) in r" :key="index">
<td>
...
<td class="text-l font-weight-bold mb-0">
<a :href="'/supplies/'+data.file_name"><span class="mb-0 text-sm">
...
<form action="" method="POST" enctype= multipart/form-data>
  ...
  <div class="mb-6 pt-4">
    <label class="formbold-form-label formbold-form-label-2">
      صورة فاتورة التموين : (Accept files with .zip .rar only )
    </label>
...
axios.post("https://erp.ersal.com.sa/api/auth/displaysupply?token="+localStorage.getItem("access_token_agent")).then(
...
methods:{
    displayform:function(){
       ...
       uploadIncomeData:function(){
          ...
          axios.post("https://erp.ersal.com.sa/api/auth/insertsupply?token="+localStorage.getItem("access_token_agent"),formdata).then(
